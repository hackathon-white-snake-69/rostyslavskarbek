...
1. Open **[the workshop template](https://github.com/hackathon-white-snake-69/github-copilot-token-optimization/generate)**.
2. Owner **hackathon-white-snake-69**, name it after your username, then **Create repository**.
...
```bash
gh repo clone hackathon-red-mule-77/<your-repo-name>
