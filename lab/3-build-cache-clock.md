...
```text
Cache TTL: gpt-5.6-terra 29:48 | gpt-5.4-mini 29:43
```

Terra unavailable? Select any different model. The clock is model-level, so the reasoning effort does not create a separate timer.
